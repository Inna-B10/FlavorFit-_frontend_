  ...
  "w-fit inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-bold shadow-sm transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[1px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          'bg-transparent border border-input shadow-xs text-secondary-foreground hover:bg-secondary/80',
        ghost: '',
      ...
      size: {
        ...
        'icon-lg': 'size-10',
        'icon-xl': 'size-[46px]',
        responsive: 'h-8 w-8 md:h-9 md:w-9 xl:h-[46px] xl:w-[46px]'
      }
    },
    defaultVariants: {
      variant: 'default',
