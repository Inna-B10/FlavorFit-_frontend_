...
export default function NewPage() {
  return (
    <>
      <div className='flex h-full w-full grow flex-col items-center justify-center gap-4 text-[#5f8d4e]'>
        <div className='flex h-full w-full items-center justify-center gap-2'>
          <span className='font-sonsie text-[10rem] text-shadow-md'>4</span>
          ...
          <span className='font-sonsie -ml-3 text-[10rem] text-shadow-md'>4</span>
        </div>
