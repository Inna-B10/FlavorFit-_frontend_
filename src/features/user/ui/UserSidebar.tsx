...
export function UserSidebar({ user }: { user: UserModel }) {
  ...
  return (
    <aside className='w-2xs xl:flex hidden bg-white-pale rounded-2xl'>
      <div className='bg-linear-to-b to-20% from-green-light to-white-pale flex flex-col w-full rounded-2xl h-fit'>
